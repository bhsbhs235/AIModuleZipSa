...
부동산 AI 에이전트 모듈. 자연어로 부동산 관련 모든 작업을 수행합니다.
...
```
사용자: 양재동 11-50 매물 좀 보여줘
집  사: 양재동 11-50 주변 매물 3건을 찾았습니다. ...

사용자: 이 중에 전용면적 30평 이상인 것만 필터해줘
집  사: 조건에 맞는 매물 1건입니다. ...

사용자: 이 매물 최근 실거래가 알려줘
집  사: 최근 6개월 실거래 내역입니다. ...
```
